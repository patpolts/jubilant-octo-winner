            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          <li class="breadcrumb-item active" aria-current="adicionar"><a href="{{ route('eixos_adicionar') }}">Adicionar</a></li>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                  @if ($message)
                    <div class="card">
                      <div class="card-body"> 
                        <p>{{$message}}</p>
                        <a class="btn btn-outline" href="{{route('eixos')}}">visualizar</a>
                      </div>
                    </div>
                  @else
                      
                    <div>
                      <form action="{{$url}}" method="POST" name="addEixos">
                        @csrf
                        <div class="form-group">
                          ...
                          <small id="tituloHelp">Identificação única relacionada ao eixo</small>
                        </div>
                        <div class="form-group">
                          ...
                          <small id="tituloHelp">Descrição do eixo</small>
                        </div>
                        <div class="form-group">
